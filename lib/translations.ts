  ...
  en: {
    ...
    services: {
      backend: {
        ...
        description: "Building robust and scalable server-side applications with Node.js, Express, and .NET Core.",
      },
      database: {
        title: "Database Management",
        description:
          "Designing and optimizing databases with MongoDB and SQL Server for efficient data storage and retrieval.",
      },
      ai: {
        title: "AI & Machine Learning",
        description: "Developing intelligent applications with Python and machine learning frameworks.",
      },
    },
    projectDescriptions: {
      projectBase:
  ...
  tr: {
    ...
    services: {
      backend: {
        ...
        description: "Node.js, Express ve .NET Core ile sağlam ve ölçeklenebilir sunucu taraflı uygulamalar oluşturma.",
      },
      database: {
        title: "Veritabanı Yönetimi",
        description:
          "Verimli veri depolama ve erişim için MongoDB ve SQL Server ile veritabanları tasarlama ve optimize etme.",
      },
      ai: {
        title: "Yapay Zeka & Makine Öğrenimi",
        description: "Python ve makine öğrenimi çerçeveleri ile akıllı uygulamalar geliştirme.",
      },
    },
    projectDescriptions: {
      projectBase:
